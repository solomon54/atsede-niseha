...
export const UNIVERSITY_MASTER_MAP: AcademicMap = {
  "ዋቸሞ ዩኒቨርሲቲ (Wachemo University - WCU)": {
    "ኢንጂነሪንግና ቴክኖሎጂ ኮሌጅ (College of Engineering and Technology)": [
      ...
      "ውኃ ሃብትና መስኖ ኢንጂነሪንግ (Water Resources and Irrigation Engineering)",
      "ሰርቬይንግ ኢንጂነሪንግ (Surveying Engineering)",
    ],
    "ኮምፒውቲንግና ኢንፎርማቲክስ ትምህርት ቤት (School of Computing and Informatics)": [
    ...
    "ግብርና ኮሌጅ (College of Agriculture)": [
      ...
      "የገጠር ልማትና ግብርና ኤክስቴንሽን (Rural Development and Agricultural Extension)",
    ],
    "ቢዝነስና ኢኮኖሚክስ ኮሌጅ (College of Business and Economics)": [
      ...
      "ሎጂስቲክስና ሰፕላይ ቼይን ማኔጅመንት (Logistics and Supply Chain Management)",
    ],
